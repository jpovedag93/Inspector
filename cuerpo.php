	...
	<div class='modal-dialog'>
		<div class='modal-content'>
			<div class='modal-header'>
				...
				<h1><strong>Inspector </strong>Encontraste un documento?</h1>
			</div>
			...
			<div class='bs-example' style='position:relative;left: -15%;'>
			    <ul class='nav nav-pills'>
			        <li class='active'><a href='indexr'>Inicio</a></li>
			        <li class='active'><a href='mostdocumento'>Mostrar Documento</a></li>
			        <li class='active'><a href='foro/indexf'>Foro</a></li>
			        <li class='active'><a href='#' data-toggle='modal' data-target='#miventana'>Encontre documento</a></li>
			        <li class='active'><a href='#'>Perdí documento</a></li>
			        <li class='active'><a href='contactenos'>Contactenos</a>
...
function etiquetalogin2()
	{
		echo "
			<li class='dropdown pull-right'>
			    <a href='#' data-toggle='dropdown' class='dropdown-toggle'>" . $_SESSION['username'] . " <b class='caret'></b></a>
			    <ul class='dropdown-menu'>
			    	<li><a href='finsesion'>Cerrar sesion</a></li>			    	
			    </ul>
			</li>
		";
	}
